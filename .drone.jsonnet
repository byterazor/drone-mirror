...
local image_name = "drone-mirror";

local github_repo_name = "drone-mirror";
local github_desc = "drone plugin for mirroring public repositories";
local url = "https://rm.byterazor.de/projects/drone-mirror";

local REDMINE_PROJECT_ID="drone-mirror";
local REDMINE_URL="https://rm.byterazor.de";

local MAIN_REPO="Container/drone-mirror";
